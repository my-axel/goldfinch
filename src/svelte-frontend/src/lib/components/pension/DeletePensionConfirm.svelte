...
>
	<div class="p-6">
		<h2 class="text-lg font-semibold">{m.pension_delete_confirm_title()}</h2>
		<p class="mt-2 text-sm text-muted-foreground">
			{m.pension_delete_confirm_before()} <strong class="text-foreground">{pensionName}</strong>{m.pension_delete_confirm_after()}
		</p>
