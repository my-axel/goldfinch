<!--
@file src/lib/components/pension/PensionTypeSelectionModal.svelte
@kind component
@purpose Steuert den Dialog 'PensionTypeSelectionModal' im Bereich 'pension' inklusive Eingaben und Abschlussaktionen.
