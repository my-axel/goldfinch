...
class Settings(Base):
    ...
    # State pension rates (as percentages)
    ...
    def __repr__(self):
        return f"Settings(id={self.id}, ui_locale={self.ui_locale}, number_locale={self.number_locale}, currency={self.currency}, projection_rates={self.projection_pessimistic_rate}/{self.projection_realistic_rate}/{self.projection_optimistic_rate}, state_pension_rates={self.state_pension_pessimistic_rate}/{self.state_pension_realistic_rate}/{self.state_pension_optimistic_rate}, inflation_rate={self.inflation_rate})" 