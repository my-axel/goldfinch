...
class Settings(Base):
    ...
    def __repr__(self):
        return f"Settings(id={self.id}, ui_locale={self.ui_locale}, number_locale={self.number_locale}, currency={self.currency}, projection_rates={self.projection_pessimistic_rate}/{self.projection_realistic_rate}/{self.projection_optimistic_rate})" 